...
public abstract class CharacterEncoder {
	...
	// public void encode(ByteBuffer paramByteBuffer, OutputStream
	// paramOutputStream)
	// throws IOException
	// {
	...
	// OutputStream paramOutputStream) throws IOException {
	// ByteArrayInputStream localByteArrayInputStream = new
	...
	// public void encodeBuffer(ByteBuffer paramByteBuffer, OutputStream
	// paramOutputStream)
	// throws IOException
	// {
	// byte[] arrayOfByte = getBytes(paramByteBuffer);
