...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<String> mData = new ArrayList<String>() {
        {
            for (int i = 0; i < 50; i++) add("hello android" + i);
        }
    };
    ...
    class MyItemAnimator extends RecyclerView.ItemAnimator {
        ...
        public void runPendingAnimations() {
            ...
            Log.e(TAG, "runPendingAnimations=====" + "mPendingRemoveHolders==" + mPendingRemoveHolders.size() + "mPendingMoveHolders==" + mPendingMoveHolders.size() + "mPendingAddHolders==" + mPendingAddHolders.size());
            // first remove
            if (isRemove) {
